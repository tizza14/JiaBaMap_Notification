    ...
    <aside class="w-64 bg-white shadow-md flex flex-col">
      ...
      <nav class="flex-1 py-4">
        <ul>
          ...
          <li><router-link to="/store-profile" class="block px-6 py-3 text-gray-700 hover:bg-amber-50 transition">餐廳資訊</router-link></li>
          ...
          <li>
            ...
            >
              訂單管理
              <span v-if="activeCount > 0" class="ml-2 px-2 py-0.5 text-xs bg-red-500 text-white rounded-full">
                {{ activeCount }}
              </span>
            </router-link>
          </li>

...
const routes = [
  ...
  { path: "/createnote", name: "CreateNote", component: CreateNoteView, meta: { requiresAuth: true } },
  { path: "/previewnote", name: "PreviewNote", component: PreviewNoteView, meta: { requiresAuth: true } },
